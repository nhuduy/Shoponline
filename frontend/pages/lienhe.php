...
if(isset($_POST['btnGoiLoiNhan']))
{
    ...
    try {
        ...
        $mail->Username = 'duytn31@tdu.edu.vn';                 // SMTP username
        $mail->Password = 'imnpqkixdodtdicb';                        // SMTP password
        ...
        //Recipients
        $mail->setFrom('duytn31@tdu.edu.vn', 'Test Mail');
        $mail->addAddress('duytn31@tdu.edu.vn');                // Add a recipient
