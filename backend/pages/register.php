        ...
        <table>
            ...
            <tr>
                <td>
                    ...
                    <a href="$siteUrl/shoponline/backend/pages/kichhoattaikhoan.php?kh_tendangnhap=$kh_tendangnhap&kh_makichhoat=$kh_makichhoat">Kích hoạt tài khoản</a>
                </td>
            </tr>
            <tr>
                <td>
                    <ul>
                        <li>Xem chúng tôi qua <a href="#">Facebook</a></li>
                        <li>Xem chúng tôi qua <a href="#">Twitter</a></li>
                    </ul>
                </td>
            </tr>
        </table>
